<template>
    <div>
        ...
        <nav
            class="fixed bottom-0 top-0 z-[51] w-full max-w-[400px] bg-white p-4 shadow-[5px_0_25px_0_rgba(94,92,154,0.1)] transition-[right] duration-300 ltr:-right-[400px] rtl:-left-[400px] dark:bg-[#0F172A]"
            ...
            <client-only>
                ...
                >
                    <div>
                        ...
                        <!-- Color Scheme removido - Dark mode é fixo -->
                        <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                            ...
                            <p class="text-xs text-white-dark">Dark mode está sempre ativo.</p>
                            <div class="mt-3">
                                <button
                                    type="button"
                        ...
                        <div class="mb-3 rounded-md border border-dashed border-[#e0e6ed] p-3 dark:border-[#1b2e4b]">
                            ...
                            <div class="mt-3">
                                <select v-model="store.animation" class="selectize form-select border-primary text-primary" @change="store.toggleAnimation()">
