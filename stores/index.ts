...
export const useAppStore = defineStore('app', {
    ...
    actions: {
        ...
        toggleHideValues(payload: boolean | null = null) {
            this.hideValues = payload ?? !this.hideValues;
            if (process.client) localStorage.setItem('hideValues', String(this.hideValues));
        },
