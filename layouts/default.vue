<template>
    <div
        ...
        :class="[store.sidebar ? 'toggle-sidebar' : '', store.menu || 'vertical', store.layout || 'full', store.rtlClass || 'ltr']"
    >
        ...
        <div class="relative">
            ...
            <ClientOnly>
                <div
                    ...
                    class="screen_loader animate__animated fixed inset-0 z-[60] grid place-content-center bg-[#F9FAFB] dark:bg-[#020617]"
                >
                    <svg width="64" height="64" viewBox="0 0 135 135" xmlns="http://www.w3.org/2000/svg" fill="#22C55E">
                        <path
            ...
            <ClientOnly>
                <div class="fixed bottom-6 z-50 ltr:right-6 rtl:left-6">
                    <template v-if="showTopButton">
                        <button
                            type="button"
                            class="btn btn-outline-primary animate-pulse rounded-full bg-[#F9FAFB] p-2 dark:bg-[#020617] dark:hover:bg-primary"
                            @click="goToTop"
                        >
            ...
            <div class="main-container min-h-screen text-black dark:text-white-dark" :class="[store.navbar]">
                ...
                <div class="main-content flex flex-col min-h-screen">
                    ...
                    <!-- Banner: conta em análise (só operar após aprovação) -->
                    <layout-account-approval-banner />
